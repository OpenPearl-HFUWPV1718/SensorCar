...
\def\bbleditors{Herausgeber}        \def\bbleds{eds.}
\def\bbleditor{Herausgeber}          \def\bbled{ed.}
\def\bbledby{edited by}
\def\bbledition{Auflage}        \def\bbledn{edn.}
\def\bblvolume{Band}          \def\bblvol{vol.}
\def\bblof{der}
...
\def\bbleidpp{Seiten}
\def\bblchapter{Kapitel}        \def\bblchap{chap.}
