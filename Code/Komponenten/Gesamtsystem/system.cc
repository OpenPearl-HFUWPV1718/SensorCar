...
pearlrt::Device * d_leftstepmotor_out;	// systemtest.prl:8
pearlrt::Device * d_rightstepmotor_out;	// systemtest.prl:9
...
namespace pearlrt {
   int createSystemElements() {
	...
	// systemtest.prl:8
	static pearlrt::RPiDigitalOut s_leftstepmotor_out(23, 4);
	d_leftstepmotor_out = &s_leftstepmotor_out;

	// systemtest.prl:9
	static pearlrt::RPiDigitalOut s_rightstepmotor_out(19, 4);
